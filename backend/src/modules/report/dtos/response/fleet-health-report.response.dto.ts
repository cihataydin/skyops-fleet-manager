...
export class FleetHealthReportResponseDto {
  ...
  @ApiProperty({ description: 'Breakdown of drones by their current status', type: 'object' })
  statusBreakdown: Record<string, number>;

  @ApiProperty({ description: 'List of drones that have overdue maintenance', type: [GetDroneResponseDto] })
  overdueMaintenanceDrones: GetDroneResponseDto[];

  @ApiProperty({ description: 'Number of missions scheduled in the next 24 hours' })
