...
export class MissionProfile extends AutomapperProfile {
  ...
  public override get profile(): MappingProfile {
    return (mapper) => {
      createMap(mapper, Mission, GetMissionResponseDto,
        forMember(
          (d) => d.type,
          mapFrom((s) => s.type),
        ),
      ...
      createMap(mapper, Mission, CreateMissionResponseDto,
        forMember(
          (d) => d.type,
          mapFrom((s) => s.type),
        ),
      ...
      createMap(mapper, Mission, UpdateMissionResponseDto,
        forMember(
          (d) => d.type,
          mapFrom((s) => s.type),
        ),
      ...
      createMap(mapper, CreateMissionRequestDto, Mission,
        forMember(
          (d) => d.type,
          mapFrom((s) => s.type),
        ),
      );
      createMap(mapper, UpdateMissionRequestDto, Mission,
        forMember(
          (d) => d.type,
          mapFrom((s) => s.type),
        ),
