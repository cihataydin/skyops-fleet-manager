...
export class UpdateMissionRequestDto {
  ...
  @ApiProperty({
    ...
    required: false,
    description:
      'Scheduled start time of the mission (ISO 8601). Required if scheduledEndTime is provided.',
    example: '2026-08-01T08:00:00Z',
  })
  @AutoMap()
  @ValidateIf(
    (o: UpdateMissionRequestDto) =>
      o.scheduledEndTime !== undefined || o.scheduledStartTime !== undefined,
  )
  @IsDate()
  ...
  @ApiProperty({
    ...
    required: false,
    description:
      'Scheduled end time of the mission (ISO 8601). Required if scheduledStartTime is provided.',
    example: '2026-08-01T12:00:00Z',
  })
  @AutoMap()
  @ValidateIf(
    (o: UpdateMissionRequestDto) =>
      o.scheduledStartTime !== undefined || o.scheduledEndTime !== undefined,
  )
  @IsDate()
